(function () {
  ...
  function l(b, h, n, y) {
      ...
      b.bind("selectstart.mathquill", function (G) {
      ...
      b.bind("mousedown.mathquill", function (G) {
          ...
          if (3 === ba) for (ba = 0, L.clearSelection().appendTo(h); L.prev; ) L.selectLeft();
  ...
  function z(b) {
      this.init("$");
      this.firstChild.cursor = b;
      this.firstChild.textInput = function (h) {
          this.skipTextInput ||
              ("$" !== h || b.parent !== this
                  ? b.write(h)
                  : this.isEmpty()
                  ? b.insertAfter(this.parent).backspace().insertNew(new u("\\$", "$")).show()
                  : b.next
                  ? b.prev
                      ? b.write(h)
                      : b.insertBefore(this.parent)
                  : b.insertAfter(this.parent));
      };
  }
  function d() {}
  function f(b, h) {
  ...
  function P(b) {
      b instanceof t ? (this.replacedText = b.remove().jQ.text()) : "string" === typeof b && (this.replacedText = b);
      this.init();
  }
  function ca() {}
  function Y(b, h) {
  ...
  function pa(b) {
      this.init("\\");
      b &&
          ((this.replacedFragment = b.detach()),
  ...
  function ja(b, h) {
      k.call(this, b, '<span class="nonSymbola">' + (h || b) + "</span>");
  }
  function I(b, h, n) {
  ...
  p.init = function (b, h, n, y) {
      ...
      this.jQ = J(this.html_template[0]).data("[[mathquill internal data]]", {
          cmd: this,
      });
      this.initBlocks(y);
  };
  p.initBlocks = function (b) {
      if (1 === this.html_template.length)
          (this.firstChild = this.lastChild = this.jQ.data("[[mathquill internal data]]").block = (b && b.blockify()) || new r()), (this.firstChild.parent = this), (this.firstChild.jQ = this.jQ.append(this.firstChild.jQ));
      else {
          var h,
              n = this.html_template.length;
          this.firstChild = b = h = (b && b.blockify()) || new r();
          b.parent = this;
          b.jQ = J(this.html_template[1]).data("[[mathquill internal data]]", { block: b }).append(b.jQ).appendTo(this.jQ);
          b.blur();
          for (var y = 2; y < n; y += 1) (b = new r()), (b.parent = this), (b.prev = h), (h = h.next = b), (b.jQ = J(this.html_template[y]).data("[[mathquill internal data]]", { block: b }).appendTo(this.jQ)), b.blur();
          this.lastChild = b;
      }
  };
  p.latex = function () {
  ...
  p.text = function () {
      ...
      return this.foldChildren(this.text_template[b], function (h, n) {
          b += 1;
          var y = n.text();
          return h && "(" === this.text_template[b] && "(" === y[0] && ")" === y.slice(-1) ? h + y.slice(1, -1) + this.text_template[b] : h + n.text() + (this.text_template[b] || "");
      });
  };
  p.insertAt = function (b) {
      ...
      if ("\\matrixmid " == this.cmd) {
          ...
          b && ((b = b.blockjQ.outerHeight() / +b.blockjQ.css("fontSize").slice(0, -2)), da(this.jQ, na(1 + 0.2 * (b - 1), 1.2), 0.98 * b), this.jQ.addClass("paren"));
      }
  };
  p.respace = J.noop;
  p.placeCursor = function (b) {
      b.appendTo(
          this.foldChildren(this.firstChild, function (h, n) {
  ...
  p.text = function () {
      return this.firstChild === this.lastChild
          ...
          : this.foldChildren("(", function (b, h) {
                return b + h.text();
            }) + ")";
  };
  p.isEmpty = function () {
  ...
  p = q.prototype = new r();
  p.latex = function () {
      return r.prototype.latex.call(this).replace(/(\\[a-z]+) (?![a-z])/gi, "$1");
  };
  p.text = function () {
      return this.foldChildren("", function (b, h) {
          return b + h.text();
  ...
  p.keydown = function (b) {
      b.ctrlKey = b.ctrlKey || b.metaKey;
      switch ((b.originalEvent && b.originalEvent.keyIdentifier) || b.which) {
          case 8:
          case "Backspace":
          case "U+0008":
              if (b.ctrlKey) for (; this.cursor.prev || this.cursor.selection; ) this.cursor.backspace();
          ...
          case 35:
          case "End":
              if (b.shiftKey) for (; this.cursor.next || (b.ctrlKey && this.cursor.parent !== this); ) this.cursor.selectRight();
              else this.cursor.clearSelection().appendTo(b.ctrlKey ? this : this.cursor.parent);
              break;
          case 36:
          case "Home":
              if (b.shiftKey) for (; this.cursor.prev || (b.ctrlKey && this.cursor.parent !== this); ) this.cursor.selectLeft();
          ...
          case "Up":
              if (b.ctrlKey) break;
              if (b.shiftKey)
                  if (this.cursor.prev) for (; this.cursor.prev; ) this.cursor.selectLeft();
                  ...
                  this.cursor.parent.prev
                      ...
                      : this.cursor.parent !== this && this.cursor.clearSelection().insertBefore(this.cursor.parent.parent);
              break;
          case 39:
          case "Right":
          ...
          case "Down":
              ...
              if (b.shiftKey)
                  ...
                  this.cursor.parent.next
                      ...
                      : this.cursor.parent !== this && this.cursor.clearSelection().insertAfter(this.cursor.parent.parent);
              break;
          case 46:
          case "Del":
          case "U+007F":
              if (b.ctrlKey) for (; this.cursor.next || this.cursor.selection; ) this.cursor.deleteForward();
  ...
  p.textInput = function (b) {
      this.skipTextInput || this.cursor.write(b);
  };
  p = z.prototype = new g();
  ...
  p.renderLatex = function (b) {
      ...
      for (var n = 0; n < b.length; n += 1) {
          ...
          } else for (B = 0; B < y.length; B += 1) this.cursor.insertNew(new u(y[B]));
      }
  };
  ...
  p.redraw = function () {
      ...
      da(this.jQ.children(":first"), b, 1.2);
  };
  ...
  p.respace = function () {
      "\\int " === this.prev.cmd || (this.prev instanceof w && this.prev.cmd != this.cmd && this.prev.prev && "\\int " === this.prev.prev.cmd)
      ...
      if ((this.respaced = this.prev instanceof w && this.prev.cmd != this.cmd && !this.prev.respaced)) {
          ...
          "_" === this.cmd && "^" === this.prev.cmd && "\\left[" === this.prev.prev.cmd
              ? this.jQ.css({
                    left: (this.limit && "_" === this.cmd ? -0.25 : 0) - h / b + "em",
                    marginRight: "",
                    verticalAlign: "-0.8em",
                })
              : this.jQ.css({
                    left: (this.limit && "_" === this.cmd ? -0.25 : 0) - h / b + "em",
                    marginRight: 0.1 - na(thisWidth, h) / b + "em",
                });
      } else
      ...
      this.respaced && this.prev.prev instanceof aa ? (this.precedence = this.prev.prev.precedence) : delete this.precedence;
  ...
  p.placeCursor = function (b) {
      if (this.firstChild.isEmpty()) {
          ...
          h !== this.prev
              ? ((h = new t(this.parent, h, this).blockify()),
                (h.jQ = this.firstChild.jQ.empty().removeClass("empty").append(h.jQ).data("[[mathquill internal data]]", { block: h })),
                (h.next = this.lastChild),
                (h.parent = this),
                (this.firstChild = this.lastChild.prev = h),
                b.appendTo(this.lastChild))
              : b.appendTo(this.firstChild);
  ...
  p.redraw = function () {
      ...
      da(b.prev(), 1, b.innerHeight() / +b.css("fontSize").slice(0, -2) - 0.1);
  };
  e.sqrt = e["\u221a"] = A;
  p = N.prototype = new g();
  ...
  p.initBlocks = function (b) {
      ...
      this.firstChild.parent = this;
      this.firstChild.jQ = this.jQ.children(":eq(1)").data("[[mathquill internal data]]", { block: this.firstChild }).append(this.firstChild.jQ);
  ...
  p.redraw = function () {
      ...
      da(this.bracketjQs, na(1 + 0.2 * (b - 1), 1.2), 1.05 * b);
  };
  ...
  p.placeCursor = function (b) {
      ...
      if (this.replacedText) for (b = 0; b < this.replacedText.length; b += 1) this.write(this.replacedText.charAt(b));
  };
  p.write = function (b) {
      this.cursor.insertNew(new u(b));
  };
  p.keydown = function (b) {
      return this.cursor.selection || ((8 !== b.which || this.cursor.prev) && (46 !== b.which || this.cursor.next)) ? this.parent.keydown(b) : (this.isEmpty() && this.cursor.insertAfter(this), !1);
  };
  p.textInput = function (b) {
      ...
      "$" !== b
          ...
          : this.cursor.next
          ? this.cursor.prev
              ? ((b = new P(new t(this.firstChild, this.cursor.prev))),
                (b.placeCursor = function (h) {
                    this.prev = 0;
                ...
                (b.prev = this),
                this.cursor.insertBefore(b),
                delete b.firstChild.focus)
  ...
  e.em = e.italic = e.italics = e.emph = e.textit = e.textsl = Y("\\textit", '<i class="text"></i>');
  ...
  e.linethrough = Y("\\linethrough", '<span style="text-decoration:line-through red" class="text"></span>');
      ...
      this.replacedFragment &&
          (this.jQ = this.jQ.add(
              this.replacedFragment.jQ
                  .addClass("blur")
                  .bind("mousedown mousemove", function (h) {
  ...
  p.renderCommand = function () {
      ...
      var b = this.firstChild.latex();
      b ? this.cursor.insertCmd(b, this.replacedFragment) : ((b = new u("\\backslash ", "\\")), this.cursor.insertNew(b), this.replacedFragment && this.replacedFragment.remove());
  };
  U["\\"] = pa;
      ...
      if (h.parent === this) {
          if (13 === b.which)
              return (
                  (b = new r()),
                  (b.parent = this),
                  (b.jQ = J("<span></span>").data("[[mathquill internal data]]", { block: b }).insertAfter(h.jQ)),
                  h.next ? (h.next.prev = b) : (this.lastChild = b),
                  (b.next = h.next),
                  (h.next = b),
                  (b.prev = h),
          ...
          if (9 === b.which && !b.shiftKey && !h.next) {
              ...
              b = new r();
              b.parent = this;
              b.jQ = J("<span></span>").data("[[mathquill internal data]]", { block: b }).appendTo(this.jQ);
              this.lastChild = b;
              h.next = b;
              b.prev = h;
              this.cursor.appendTo(b).redraw();
          ...
          if (8 === b.which) {
              if (h.isEmpty())
                  return (
                      h.prev ? (this.cursor.appendTo(h.prev), (h.prev.next = h.next)) : (this.cursor.insertBefore(this), (this.firstChild = h.next)),
                      h.next ? (h.next.prev = h.prev) : (this.lastChild = h.prev),
                      h.jQ.remove(),
  ...
  p.initMatrix = function (b) {
      ...
      for (var F = 0; F < n; F += 1) {
          var H = [];
          this.matrix.push(H);
          for (var D = (H.jQ = J("<tr/>").appendTo(this.tablejQ)), Q = 0; Q < y; Q += 1)
              0 === F && 0 === Q ? (this.firstChild = B = (b && b.blockify()) || new r()) : (B = new r()),
                  (B.parent = this),
                  (B.prev = h),
                  (h = h.next = B),
                  (B.row = F),
                  (B.col = Q),
                  (B.jQ = J("<td/>").data("[[mathquill internal data]]", { block: B }).append(B.jQ).appendTo(D)),
                  H.push(B),
                  B.blur();
      }
      this.lastChild = h;
  ...
  p.keydown = function (b) {
      ...
      if (h.parent === this)
          if (8 === b.which) {
              ...
              var n = h.row;
              h = h.col;
              (13 === b.which ? b.shiftKey : 38 === b.which) ? 0 < n && this.cursor.appendTo(this.matrix[n - 1][h]) : n < this.matrix.length - 1 && this.cursor.prependTo(this.matrix[n + 1][h]);
          }
      return this.parent.keydown(b);
  };
  p.textInput = function (b) {
  ...
  p.text = function () {
      ...
      !this.next || this.next instanceof I || "^" === this.next.cmd || (b += "*");
      return b;
  };
  ...
  xa.redraw = function () {
      var b = this.blockjQ.outerHeight() / +this.blockjQ.css("fontSize").slice(0, -2);
      da(this.bracketjQs, na(1 + 0.3 * (b - 1), 1.3), 1.05 * b);
  };
  ...
  e["&"] = a(ja, "\\&", "&");
  e["%"] = a(ja, "\\%", "%");
  e.alpha = e.beta = e.gamma = e.delta = e.zeta = e.eta = e.theta = e.iota = e.kappa = e.mu = e.nu = e.xi = e.rho = e.sigma = e.tau = e.chi = e.psi = e.omega = f(k, function (b, h) {
      T.call(this, "\\" + h + " ", "&" + h + ";");
  });
  e.phi = a(T, "\\phi ", "&#981;");
  ...
  p.respace = function () {
      this.jQ[0].className = this.prev ? (this.prev instanceof I && this.next && !(this.next instanceof I) ? "unary-operator" : "binary-operator") : "";
      return this;
  };
  e["+"] = a(la, "+", "+");
  e["\u2013"] = e["-"] = a(la, "-", "&minus;");
  ...
  e.sube = e.subeq = e.subsete = e.subseteq = a(I, "\\subseteq ", "&sube;");
  ...
  e["\u220f"] = e.prod = e.product = a(aa, "\\prod ", "&prod;");
  ...
  e.C = e.complex = e.Complex = e.complexes = e.Complexes = e.complexplane = e.Complexplane = e.ComplexPlane = a(u, "\\mathbb{C}", "&#8450;");
  ...
  e.converges = e.darr = e.dnarr = e.dnarrow = e.downarrow = a(u, "\\downarrow ", "&darr;");
  ...
  e.xist = e.xists = e.exist = e.exists = a(u, "\\exists ", "&exist;");
  ...
  p.respace = function () {
      this.jQ[0].className = this.next instanceof w || this.next instanceof K ? "" : "non-italicized-function";
  };
  ...
  p.show = function () {
      ...
      "intervalId" in this
          ...
          : (this.next ? (this.selection && this.selection.prev === this.prev ? this.jQ.insertBefore(this.selection.jQ) : this.jQ.insertBefore(this.next.jQ.first())) : this.jQ.appendTo(this.parent.jQ), this.parent.focus());
  ...
  p.seek = function (b, h, n) {
      ...
      if (b.hasClass("empty")) return n.prependTo(b.data("[[mathquill internal data]]").block), n;
      ...
      } else (b = b.parent()), (y = b.data("[[mathquill internal data]]")) || (y = { block: n.root });
      y.cmd ? n.insertAfter(y.cmd) : n.appendTo(y.block);
      b = n.jQ.offset().left - h;
      do n.moveLeft(), (y = b), (b = n.jQ.offset().left - h);
      while (0 < b && (n.prev || n.parent !== n.root));
      -b > y && n.moveRight();
      return n;
  };
  p.replaceIntervalParentheses = function (b) {
      for (var h = [], n = [], y = 0; y < b.length; y++) {
          ...
          "(" === B || "[" === B
              ? n.push({ ind: y, type: B })
              : ")" === B
              ? (B = n.pop()) && "[" === B.type && (h.push({ index: B.ind, value: "LEFTCLOSED" }), h.push({ index: y, value: "RIGHTOPEN" }))
              : "]" === B && (B = n.pop()) && "(" === B.type && (h.push({ index: B.ind, value: "LEFTOPEN" }), h.push({ index: y, value: "RIGHTCLOSED" }));
      }
  ...
  p.writeLatex = function (b) {
      ...
      b = b.replace(/f'/g, "f\\:'");
      b = ((b = b.replace(/f\\prime/g, "f\\:\\prime")) && b.match(/\\(?:begin|end){cases}|\\(?:begin|end){([pbv]|small)?matrix}|\\\\|\\mathbb{[CNPQRZ]}|\\text{([^}]|\\})*}|\\:|\\[a-z]*|[^\s]/gi)) || 0;
      ...
      (function B(n, y) {
          if ("]" == b) n.insertNew(new u(b));
              ...
              for (; b.length; ) {
                  ...
                  else (H = F.match(/[a-zA-Z\u00E1-\u00F3]/) ? new T(F) : (H = e[F]) ? new H() : "#" == F || "\\:" == F ? new U[" "]() : new u(F)), n.insertNew(H);
  ...
  p.insertCh = function (b) {
      ...
      var h = b.match(/^[a-zA-Z]$/) ? new T(b) : (h = U[b] || e[b]) ? new h(this.selection, b) : new u(b);
  ...
  p.insertCmd = function (b, h) {
      var n = e[b];
      n
          ? ((n = new n(h, b)), this.insertNew(n), n instanceof k && h && h.remove())
          : ((n = new P(b)),
            (n.firstChild.focus = function () {
                delete this.focus;
                return this;
            }),
            this.insertNew(n).insertAfter(n),
            h && h.remove());
      return this;
  };
  p.unwrapGramp = function () {
      ...
      b.eachChild(function (y) {
          y.isEmpty() ||
              ...
              (y.firstChild.prev = n) ? (n.next = y.firstChild) : (h.firstChild = y.firstChild),
              (n = y.lastChild));
      });
  ...
  p.selectWord = function () {
      ...
      this.hide().selection = new ma(this.parent, h, b);
  };
  ...
  p.selectLeft = function () {
      if (this.selection)
          if (this.selection.prev === this.prev)
              this.prev ? (this.hopLeft().next.jQ.prependTo(this.selection.jQ), (this.selection.prev = this.prev)) : this.parent !== this.root && this.insertBefore(this.parent.parent).selection.levelUp();
          else {
  ...
  p.selectRight = function () {
      if (this.selection)
          if (this.selection.next === this.next) this.next ? (this.hopRight().prev.jQ.appendTo(this.selection.jQ), (this.selection.next = this.next)) : this.parent !== this.root && this.insertAfter(this.parent.parent).selection.levelUp();
              ...
              if ((this.next.jQ.insertBefore(this.selection.jQ), (this.hopRight().selection.prev = this.prev), this.selection.next === this.next)) {
                  this.deleteSelection();
                  return;
              }
          }
          ...
          case "write":
              if (1 < arguments.length)
                  return this.each(function () {
                      ...
                      if (Q) {
                          Q.writeLatex(h);
                          if (n != O) for (i = 0; i < n; i++) Q.moveLeft();
                          D.blur();
                      }
                  });
          case "cmd":
              if (1 < arguments.length)
                  return this.each(function () {
                      ...
                      if (Q) {
                          Q.writeLatex(h);
                          if (n != O) for (i = 0; i < n; i += 1) Q.moveLeft();
                          D.blur();
                      }
                  });
          case "backspace":
...
(function (c, g) {
  "function" === typeof define && define.amd
      ...
      ? (module.exports = g(require("jquery")))
      : g(jQuery);
})(this, function (c) {
  function g(d) {
      this.$container;
  ...
  function r(d) {
      var f = d.attr("id");
      return (f = f ? q.window.document.getElementById(f) : null) ? f === d[0] : c.contains(q.window.document.body, d[0]);
  }
  var t = {
          animation: "fade",
      ...
      q = {
          ...
          hasTransitions: (function () {
              ...
              for (var m = 0; m < a.length; m++) if ("string" == typeof d[a[m] + f]) return !0;
              return !1;
          })(),
          IE: !1,
          semVer: "4.1.6",
  ...
  z.prototype = {
      __bridge: function (d, f, a) {
          if (!f[a]) {
              ...
              c.each(d, function (x, w) {
                  0 != x.indexOf("__") &&
                      (f[x]
                          ? t.debug && console.log("The " + x + " method of the " + a + " plugin conflicts with another plugin or native methods")
                          : ((f[x] = function () {
      ...
      _plugin: function (d) {
          if ("string" == typeof d) {
              ...
              0 < d.indexOf(".")
                  ? (f = this.__plugins[d])
                  : c.each(this.__plugins, function (a, m) {
  ...
  c.Tooltipster.prototype = {
      __init: function (d, f) {
          ...
          if (!q.IE || q.IE >= a.__options.IEmin) {
              ...
              if (null !== a.__options.content) a.__contentSet(a.__options.content);
                  ...
                  var m;
                  f && (m = c(f));
                  m && m[0] ? a.__contentSet(m.first()) : a.__contentSet(d);
              }
              ...
              if (q.hasTouchCapability)
                  c("body").on("touchmove." + a.__namespace + "-triggerOpen", function (v) {
      ...
      __contentInsert: function () {
          ...
          this.__options.functionFormat && (f = this.__options.functionFormat.call(this, this, { origin: this._$origin[0] }, this.__Content));
      ...
      __contentSet: function (d) {
          ...
          this.__Content = d;
          this._trigger({ type: "updated", content: d });
          return this;
      },
      ...
      __geometry: function () {
          ...
          var w = {
              ...
              document: { size: { height: v.height(), width: v.width() } },
              window: {
                  scroll: {
                  ...
                  size: { height: x.height(), width: x.width() },
              },
              origin: {
                  fixedLineage: !1,
                  offset: {},
                  size: { height: m.bottom - m.top, width: m.right - m.left },
          ...
          w.available.document = {
              ...
              left: { height: w.document.size.height, width: w.origin.offset.left },
              right: {
                  height: w.document.size.height,
                  width: w.document.size.width - w.origin.offset.right,
              },
              top: { height: w.origin.offset.top, width: w.document.size.width },
          };
          for (
              w.available.window = {
                  bottom: {
                      height: Math.max(w.window.size.height - Math.max(w.origin.windowOffset.bottom, 0), 0),
      ...
      __optionsFormat: function () {
          ...
          "string" == typeof this.__options.parent && (this.__options.parent = c(this.__options.parent));
      ...
      __prepareGC: function () {
          var d = this;
          d.__options.selfDestruction
              ? (d.__garbageCollector = setInterval(function () {
      ...
      __prepareOrigin: function () {
          ...
          if (q.hasTouchCapability)
              d._$origin.on("touchstart." + d.__namespace + "-triggerOpen touchend." + d.__namespace + "-triggerOpen touchcancel." + d.__namespace + "-triggerOpen", function (a) {
                  d._touchRecordEvent(a);
              });
          if (d.__options.triggerOpen.click || (d.__options.triggerOpen.tap && q.hasTouchCapability)) {
              var f = "";
          ...
          if (d.__options.triggerOpen.mouseenter || (d.__options.triggerOpen.touchstart && q.hasTouchCapability))
              (f = ""),
                  d.__options.triggerOpen.mouseenter && (f += "mouseenter." + d.__namespace + "-triggerOpen "),
                  d.__options.triggerOpen.touchstart && q.hasTouchCapability && (f += "touchstart." + d.__namespace + "-triggerOpen"),
                  d._$origin.on(f, function (a) {
                      if (d._touchIsTouchEvent(a) || !d._touchIsEmulatedEvent(a)) (d.__pointerIsOverOrigin = !0), d._openShortly(a);
                  });
          if (d.__options.triggerClose.mouseleave || (d.__options.triggerClose.touchleave && q.hasTouchCapability))
              (f = ""),
                  d.__options.triggerClose.mouseleave && (f += "mouseleave." + d.__namespace + "-triggerOpen "),
                  d.__options.triggerClose.touchleave && q.hasTouchCapability && (f += "touchend." + d.__namespace + "-triggerOpen touchcancel." + d.__namespace + "-triggerOpen"),
                  d._$origin.on(f, function (a) {
      ...
      __prepareTooltip: function () {
          ...
          d._$tooltip.attr("id", d.__namespace).css({ "pointer-events": f, zIndex: d.__options.zIndex });
          ...
          if (this.__options.triggerClose.scroll) this._close(d);
              ...
              if (d.target === q.window.document) this.__Geometry.origin.fixedLineage || (this.__options.repositionOnScroll && this.reposition(d));
                  ...
                  "fixed" != this._$origin.css("position") &&
                      this.__$originParents.each(function (m, v) {
                          m = c(v);
                          ...
                          if ("visible" != x || "visible" != w)
                              if (
                                  ...
                                  ("visible" != x && (f.origin.windowOffset.left < v.left || f.origin.windowOffset.right > v.right)) || ("visible" != w && (f.origin.windowOffset.top < v.top || f.origin.windowOffset.bottom > v.bottom)))
                              )
                                  return (a = !0), !1;
              ...
              this._trigger({ type: "scroll", event: d });
          }
          return this;
      },
      __stateSet: function (d) {
          this.__state = d;
          this._trigger({ type: "state", state: d });
          return this;
      },
          ...
          if (m || a.__destroying) {
              ...
              var v = function () {
                  c.each(a.__callbacks.close, function (w, E) {
                      E.call(a, a, { event: d, origin: a._$origin[0] });
                  });
                  a.__callbacks.close = [];
              };
              if ("closed" != a.__state) {
                  ...
                  f &&
                      ((a.__closingTime = x),
                      "disappearing" != a.__state && a.__stateSet("disappearing"),
                      (f = function () {
                          clearInterval(a.__tracker);
                          a._trigger({ type: "closing", event: d });
                          ...
                          a._off("dismissable");
                          a.__stateSet("closed");
                          a._trigger({ type: "after", event: d });
                          a.__options.functionAfter &&
                              a.__options.functionAfter.call(a, a, {
                                  event: d,
                                  origin: a._$origin[0],
                              });
                          v();
                      ...
                      q.hasTransitions
                          ? (a._$tooltip.css({
                            ...
                            a._$tooltip.clearQueue().removeClass("tooltipster-show").addClass("tooltipster-dying"),
                            0 < a.__options.animationDuration[1] && a._$tooltip.delay(a.__options.animationDuration[1]),
                            a._$tooltip.queue(f))
                          : a._$tooltip.stop().fadeOut(a.__options.animationDuration[1], f));
              } else v();
          }
          return a;
      },
      ...
      _open: function (d, f) {
          ...
          if (!a.__destroying && r(a._$origin) && a.__enabled) {
              ...
              "closed" == a.__state &&
                  ...
                  m &&
                      a.__options.functionBefore &&
                      (m = a.__options.functionBefore.call(a, a, {
                          event: d,
                          origin: a._$origin[0],
                      })));
              if (!1 !== m && null !== a.__Content) {
                  ...
                  var v = function () {
                      ...
                      c.each(a.__callbacks.open, function (C, A) {
                          A.call(a, a, { origin: a._$origin[0], tooltip: a._$tooltip[0] });
                      });
                      a.__callbacks.open = [];
                  };
                  if ("closed" !== a.__state)
                      (f = 0),
                          "disappearing" === a.__state
                              ? (a.__stateSet("appearing"),
                                q.hasTransitions
                                    ? (a._$tooltip.clearQueue().removeClass("tooltipster-dying").addClass("tooltipster-show"),
                                      0 < a.__options.animationDuration[0] && a._$tooltip.delay(a.__options.animationDuration[0]),
                                      a._$tooltip.queue(v))
                                    : a._$tooltip.stop().fadeIn(v))
                              : "stable" == a.__state && v();
                  else {
                      a.__stateSet("appearing");
                      ...
                      q.hasTransitions
                          ? (a._$tooltip
                                .addClass("tooltipster-" + a.__options.animation)
                            ...
                            setTimeout(function () {
                                "closed" != a.__state &&
                                    (a._$tooltip.addClass("tooltipster-show").removeClass("tooltipster-initial"), 0 < a.__options.animationDuration[0] && a._$tooltip.delay(a.__options.animationDuration[0]), a._$tooltip.queue(v));
                            }, 0))
                          : a._$tooltip.css("display", "none").fadeIn(a.__options.animationDuration[0], v);
                      a.__trackerStart();
                      c(q.window)
                          .on("resize." + a.__namespace + "-triggerClose", function (C) {
                              var A = c(document.activeElement);
                              ((A.is("input") || A.is("textarea")) && c.contains(a._$tooltip[0], A[0])) || a.reposition(C);
                          })
                      ...
                      if (a.__options.triggerClose.mouseleave || (a.__options.triggerClose.touchleave && q.hasTouchCapability)) {
                          ...
                          a.__options.triggerClose.touchleave &&
                              ...
                              ((x += "touchstart." + a.__namespace + "-triggerClose"), (w += "touchend." + a.__namespace + "-triggerClose touchcancel." + a.__namespace + "-triggerClose"));
                          d.on(w, function (C) {
                              (!a._touchIsTouchEvent(C) && a._touchIsEmulatedEvent(C)) ||
                                  a._trigger({
                      ...
                      if (a.__options.triggerClose.originClick)
                          a._$origin.on("click." + a.__namespace + "-triggerClose", function (C) {
                              a._touchIsTouchEvent(C) || a._touchIsEmulatedEvent(C) || a._close(C);
                          });
                      (a.__options.triggerClose.click || (a.__options.triggerClose.tap && q.hasTouchCapability)) &&
                          setTimeout(function () {
                              if ("closed" != a.__state) {
                                  var C = "";
                                  ...
                                  if (a.__options.triggerClose.tap && q.hasTouchCapability)
                                      c("body").on("touchstart." + a.__namespace + "-triggerClose", function (A) {
                                          a._touchRecordEvent(A);
                                      });
                              }
                          }, 0);
                      a._trigger("ready");
                      a.__options.functionReady &&
                          a.__options.functionReady.call(a, a, {
                              origin: a._$origin[0],
      ...
      _openShortly: function (d) {
          ...
          if (
              ...
              var m = 0 == d.type.indexOf("touch") ? f.__options.delayTouch : f.__options.delay;
              m[0]
                  ? (f.__timeouts.open = setTimeout(function () {
      ...
      _optionsExtract: function (d, f) {
          ...
          v ||
              ((v = {}),
              c.each(f, function (x, w) {
                  w = a.__options[x];
                  void 0 !== w && (v[x] = w);
              }));
          c.each(m, function (x, w) {
              void 0 !== v[x] && ("object" != typeof w || w instanceof Array || null == w || "object" != typeof v[x] || v[x] instanceof Array || null == v[x] ? (m[x] = v[x]) : c.extend(m[x], v[x]));
          });
          return m;
      },
      _plug: function (d) {
      ...
      _touchIsMeaningfulEvent: function (d) {
          return (this._touchIsTouchEvent(d) && !this._touchSwiped(d.target)) || (!this._touchIsTouchEvent(d) && !this._touchIsEmulatedEvent(d));
      },
      ...
      _unplug: function (d) {
          ...
          if (f[d]) {
              ...
              a.instance &&
                  c.each(a.instance, function (m, v) {
                      f[m] && f[m].bridged === f[d] && delete f[m];
                  });
          ...
          if (f.__destroyed) f.__destroyError();
              ...
              if ("closed" !== f.__state && (f.__contentInsert(), f.reposition(), f.__options.updateAnimation))
                  if (q.hasTransitions) {
                      ...
                      f._$tooltip.addClass("tooltipster-update-" + a);
                      setTimeout(function () {
                          "closed" != f.__state && f._$tooltip.removeClass("tooltipster-update-" + a);
                      }, 1e3);
                  } else
                      f._$tooltip.fadeTo(200, 0.5, function () {
      ...
      destroy: function () {
          ...
          d.__destroyed
              ...
              : d.__destroying ||
                ((d.__destroying = !0),
                d._close(null, function () {
                    d._trigger("destroy");
                    d.__destroying = !1;
                    d.__destroyed = !0;
                    d._$origin.removeData(d.__namespace).off("." + d.__namespace + "-triggerOpen");
                    c("body").off("." + d.__namespace + "-triggerOpen");
                    var f = d._$origin.data("tooltipster-ns");
                    f &&
                        (1 === f.length
                            ? ((f = null),
                              "previous" == d.__options.restoration
                                  ? (f = d._$origin.data("tooltipster-initialTitle"))
                                  : "current" == d.__options.restoration && (f = "string" == typeof d.__Content ? d.__Content : c("<div></div>").append(d.__Content).html()),
                              f && d._$origin.attr("title", f),
                              d._$origin.removeClass("tooltipstered"),
                              d._$origin.removeData("tooltipster-ns").removeData("tooltipster-initialTitle"))
                            : ((f = c.grep(f, function (a, m) {
                                  return a !== d.__namespace;
                              })),
                              d._$origin.data("tooltipster-ns", f)));
      ...
      one: function () {
          this.__destroyed ? this.__destroyError() : this.__$emitterPublic.one.apply(this.__$emitterPublic, Array.prototype.slice.apply(arguments));
          return this;
      },
      open: function (d) {
      ...
      option: function (d, f) {
          ...
          this.__destroyed
              ? this.__destroyError()
              : ((this.__options[d] = f), this.__optionsFormat(), 0 <= c.inArray(d, ["trigger", "triggerClose", "triggerOpen"]) && this.__prepareOrigin(), "selfDestruction" === d && this.__prepareGC());
          return this;
      },
      ...
      triggerHandler: function () {
          this.__destroyed ? this.__destroyError() : this.__$emitterPublic.triggerHandler.apply(this.__$emitterPublic, Array.prototype.slice.apply(arguments));
          return this;
      },
  };
  c.fn.tooltipster = function () {
          ...
          this.each(function () {
              ...
              if ((E = E ? c(this).data(E[0]) : null)) {
                  if ("function" === typeof E[d[0]]) {
                      1 < this.length &&
                          "content" == d[0] &&
                          (d[1] instanceof c || ("object" == typeof d[1] && null != d[1] && d[1].tagName)) &&
                          !E.__options.contentCloning &&
                          E.__options.debug &&
                          console.log("You are using a single HTML element as content for several tooltips. You probably want to set the contentCloning option to TRUE.");
                      var C = E[d[0]](d[1], d[2]);
      ...
      1 < this.length &&
          (a instanceof c || ("object" == typeof a && null != a && a.tagName)) &&
          !v &&
          w &&
          console.log("You are using a single HTML element as content for several tooltips. You probably want to set the contentCloning option to TRUE.");
      this.each(function () {
          ...
          E &&
              ((N = new c.Tooltipster(this, d[0])),
              (A ||= []),
              A.push(N.__namespace),
              C.data("tooltipster-ns", A),
              C.data(N.__namespace, N),
  ...
  g.prototype = {
      ...
      constrain: function (d, f) {
          this.constraints = { width: d, height: f };
          this.__$tooltip.css({
              display: "block",
              height: "",
              overflow: "auto",
      ...
      destroy: function () {
          this.__$tooltip.detach().find(".tooltipster-content").css({ display: "", overflow: "" });
      ...
      measure: function () {
          ...
          var d = this.__$tooltip[0].getBoundingClientRect(),
              f = {
                  size: { height: d.height || d.bottom, width: d.width || d.right },
              };
          if (this.constraints) {
              var a = this.__$tooltip.find(".tooltipster-content"),
                  m = this.__$tooltip.outerHeight(),
                  v = a[0].getBoundingClientRect();
              d = d.width <= this.constraints.width && v.width >= a[0].scrollWidth - 1;
  ...
  -1 != z.indexOf("msie")
      ? (q.IE = parseInt(z.split("msie")[1]))
      : -1 !== z.toLowerCase().indexOf("trident") && -1 !== z.indexOf(" rv:11")
      ? (q.IE = 11)
      : -1 != z.toLowerCase().indexOf("edge/") && (q.IE = parseInt(z.toLowerCase().split("edge/")[1]));
  c.tooltipster._plugin({
      ...
      instance: {
          ...
          __init: function (d) {
              ...
              f.__instance._on("options." + f.__namespace, function () {
                  f.__optionsFormat();
              });
          ...
          __optionsFormat: function () {
              ...
              4 > this.__options.distance.length &&
                  (void 0 === this.__options.distance[1] && (this.__options.distance[1] = this.__options.distance[0]),
              ...
              "string" == typeof this.__options.side &&
                  ((this.__options.side = [this.__options.side, { top: "bottom", right: "left", bottom: "top", left: "right" }[this.__options.side]]),
          ...
          __reposition: function (d, f) {
                      ...
                      for (K = 0; K < m.__options.side.length; K++) {
                          ...
                          c.each(["natural", "constrained"], function (P, ca) {
                              ...
                              if (1 == R || (0 != R && 0 == C)) {
                                  ...
                                  var Y = ("natural" == ca ? E.free() : E.constrain(f.geo.available[M][S].width - X.horizontal, f.geo.available[M][S].height - X.vertical)).measure();
                                  P.size = Y.size;
                                  P.outerSize = {
                                  ...
                                  "window" == M &&
                                      (P.whole = P.fits
                                          ? "top" == S || "bottom" == S
                                              ? f.geo.origin.windowOffset.right >= m.__options.minIntersection && f.geo.window.size.width - f.geo.origin.windowOffset.left >= m.__options.minIntersection
                                              : f.geo.origin.windowOffset.bottom >= m.__options.minIntersection && f.geo.window.size.height - f.geo.origin.windowOffset.top >= m.__options.minIntersection
                                          : !1);
                                  x.push(P);
                                  if (P.whole) C = !0;
              ...
              x.sort(function (K, M) {
                  ...
                  return K.fits && !M.fits
                      ? -1
                      : !K.fits && M.fits
                      ? 1
                      : K.fits && M.fits
                      ? ((R = m.__options.side.indexOf(K.side)), (M = m.__options.side.indexOf(M.side)), R < M ? -1 : R > M ? 1 : "natural" == K.mode ? -1 : 1)
                      : "document" == K.container && "bottom" == K.side && "natural" == K.mode
                      ? -1
                      : 1;
              });
              var A = x[0];
              ...
              switch (A.side) {
                  case "left":
                      A.coord.left = f.geo.origin.windowOffset.left - A.outerSize.width;
                      break;
                  case "right":
              ...
              "window" == A.container
                  ? "top" == A.side || "bottom" == A.side
                      ? 0 > A.coord.left
                          ? (A.coord.left = 0 <= f.geo.origin.windowOffset.right - this.__options.minIntersection ? 0 : f.geo.origin.windowOffset.right - this.__options.minIntersection - 1)
                          : A.coord.left > f.geo.window.size.width - A.size.width &&
                            (A.coord.left =
                                f.geo.origin.windowOffset.left + this.__options.minIntersection <= f.geo.window.size.width
                                    ? f.geo.window.size.width - A.size.width
                                    : f.geo.origin.windowOffset.left + this.__options.minIntersection + 1 - A.size.width)
                      : 0 > A.coord.top
                      ? (A.coord.top = 0 <= f.geo.origin.windowOffset.bottom - this.__options.minIntersection ? 0 : f.geo.origin.windowOffset.bottom - this.__options.minIntersection - 1)
                      : A.coord.top > f.geo.window.size.height - A.size.height &&
                        (A.coord.top =
                            f.geo.origin.windowOffset.top + this.__options.minIntersection <= f.geo.window.size.height
                                ? f.geo.window.size.height - A.size.height
                                : f.geo.origin.windowOffset.top + this.__options.minIntersection + 1 - A.size.height)
                  : (A.coord.left > f.geo.window.size.width - A.size.width && (A.coord.left = f.geo.window.size.width - A.size.width), 0 > A.coord.left && (A.coord.left = 0));
              ...
              } else (a = "top"), (N = A.target - A.coord.top), (V = A.size.height - this.__options.minIntersection);
              N < this.__options.minIntersection ? (N = this.__options.minIntersection) : N > V && (N = V);
              V = f.geo.origin.fixedLineage
                  ? f.geo.origin.windowOffset
                  : {
              ...
              f.geo.origin.fixedLineage ? m.__instance._$tooltip.css("position", "fixed") : m.__instance._$tooltip.css("position", "");
              m.__instance._$tooltip
                  .css({
                      left: A.coord.left,
                      top: A.coord.top,
              ...
              m.__instance._trigger({ type: "repositioned", event: d, position: A });
          },
          __sideChange: function (d, f) {
              d.removeClass("tooltipster-bottom")
                  .removeClass("tooltipster-left")
                  .removeClass("tooltipster-right")
                  .removeClass("tooltipster-top")
                  .addClass("tooltipster-" + f);
          },
          __targetFind: function (d) {
              var f = {},
                  a = this.__instance._$origin[0].getClientRects();
              1 < a.length && 1 == this.__instance._$origin.css("opacity") && (this.__instance._$origin.css("opacity", 0.99), (a = this.__instance._$origin[0].getClientRects()), this.__instance._$origin.css("opacity", 1));
              2 > a.length
                  ? ((f.top = Math.floor(d.geo.origin.windowOffset.left + d.geo.origin.size.width / 2)), (f.bottom = f.top), (f.left = Math.floor(d.geo.origin.windowOffset.top + d.geo.origin.size.height / 2)), (f.right = f.left))
                  : ((d = a[0]),
                    (f.top = Math.floor(d.left + (d.right - d.left) / 2)),
                    (d = 2 < a.length ? a[Math.ceil(a.length / 2) - 1] : a[0]),
                    (f.right = Math.floor(d.top + (d.bottom - d.top) / 2)),
                    (d = a[a.length - 1]),
                    (f.bottom = Math.floor(d.left + (d.right - d.left) / 2)),
                    (d = 2 < a.length ? a[Math.ceil((a.length + 1) / 2) - 1] : a[a.length - 1]),
                    (f.left = Math.floor(d.top + (d.bottom - d.top) / 2)));
              return f;
          },
      },
  });
  ...
  try {
      if (
          ...
          $(c).tooltipster({
              ...
              interactive: !0,
              trigger: "custom",
              triggerClose: { click: k.actionable ? !1 : !0 },
              restoration: "none",
              side: k.side,
          });
          closeOpenTooltips();
...
function createPOIContent(c, g, k) {
  g = $("<div />", { html: g, css: { display: "inline-block" } });
  g = $("<div />", { class: "sy-tooltip-content" }).append(g);
...
function createUpgradeContent(c, g, k, r) {
  var t = $("<div />", { html: k, css: { display: "inline-block" } });
  k = $("<div />", { class: "sy-tooltip-content" }).append(t);
  var l = $("<a />", {
      class: "upgradeLink",
      click: function () {
...
!(function (c) {
  ...
  var k = [],
      ...
      t = function (d, f) {
          ...
          for (var m in d) {
              var v = m.match(f);
              v && ((v = (v[1] + v[2].replace(/([A-Z])/g, "-$1")).toLowerCase()), (a[v] = d[m]));
          }
          return a;
      },
  ...
  g.prototype = {
      ...
      setup: function (d, f) {
          "object" != typeof d || 0 != d instanceof c || f || ((f = d), (d = void 0));
          var a = c.extend(this, f, { target: d });
          d = a.resetCss ? a.namespace + "-reset" : a.namespace;
          d = c(
              a.background ||
                  [
                      '<div class="' + d + "-loading " + d + '">',
                      '<div class="' + d + '-content">',
                      '<span class="' + d + "-close-icon " + a.namespace + '-close">',
                      a.closeIcon,
                      "</span>",
                      '<div class="' + a.namespace + '-inner">' + a.loading + "</div>",
                      "</div></div>",
                  ].join("")
          );
          var m = "." + a.namespace + "-close" + (a.otherClose ? "," + a.otherClose : "");
          return (
              (a.$instance = d.clone().addClass(a.variant)),
              a.$instance.on(a.closeTrigger + "." + a.namespace, function (v) {
                  var x = c(v.target);
      ...
      getContent: function () {
          ...
          var d = this.constructor.contentFilters,
              ...
              a = this.target || f || "",
              m = d[this.type];
          if ((!m && a in d && ((m = d[a]), (a = this.target && f)), (a = a || (this.$currentTarget && this.$currentTarget.attr("href")) || ""), !m)) for (var v in d) this[v] && ((m = d[v]), (a = this[v]));
          if (!m) {
              var x = a;
              if (
                  ((a = null),
                  c.each(this.contentFilters, function () {
                      return (m = d[this]), m.test && (a = m.test(x)), !a && m.regex && x.match && x.match(m.regex) && (a = x), !a;
                  }),
                  !a)
              )
                  return "console" in window && window.console.error("Featherlight: no content filter found " + (x ? ' for "' + x + '"' : " (no target specified)")), !1;
          }
          return m.process.call(this, a);
      },
      setContent: function (d) {
          return (
              (d.is("iframe") || 0 < c("iframe", d).length) && this.$instance.addClass(this.namespace + "-iframe"),
              ...
              this.$instance
                  ...
                  .remove()
                  .end()
                  .replaceWith(c.contains(this.$instance[0], d[0]) ? "" : d),
              (this.$content = d.addClass(this.namespace + "-inner")),
              this
          );
      },
      open: function (d) {
              ...
              if (a)
                  return (
                      ...
                      c
                          ...
                          .then(f.$instance.promise())
                          .done(function () {
                              f.afterOpen(d);
                          })
                  );
          }
          return f.$instance.detach(), c.Deferred().reject().promise();
      },
      close: function (d) {
          var f = this,
              a = c.Deferred();
          return (
              !1 === f.beforeClose(d)
                  ? a.reject()
                  : (0 === r(f).length && z(!1),
                    f.$instance.fadeOut(f.closeSpeed, function () {
                        f.$instance.detach();
                        f.afterClose(d);
                        a.resolve();
                    })),
  ...
  c.extend(g, {
      ...
      contentFilters: {
          jquery: {
              ...
              process: function (d) {
                  return !1 !== this.persist ? c(d) : c(d).clone(!0);
              },
          },
          image: {
          ...
          ajax: {
              ...
              process: function (d) {
                  var f = c.Deferred(),
                      a = c("<div></div>").load(d, function (m, v) {
      ...
      readElementConfig: function (d, f) {
          var a = this,
              m = new RegExp("^data-" + f + "-(.*)"),
              v = {};
          return (
      ...
      attach: function (d, f, a) {
          var m = this;
          "object" != typeof f || 0 != f instanceof c || a || ((a = f), (f = void 0));
          a = c.extend({}, a);
          var v,
              x = c.extend({}, m.defaults, m.readElementConfig(d[0], a.namespace || m.defaults.namespace), a);
          return (
              d.on(x.openTrigger + "." + x.namespace, x.filter, function (w) {
                  var E = c.extend({ $source: d, $currentTarget: c(this) }, m.readElementConfig(d[0], x.namespace), m.readElementConfig(this, x.namespace), a),
...
(function () {
  var c, g;
  if (((c = { version: "2.3.3", name: "jQuery-runner" }), (g = this.jQuery || this.Zepto || this.$), !g || !g.fn)) throw Error("[" + c.name + "] jQuery or jQuery-like library is required for this plugin to work");
  var k = {};
  var r = function (f) {
      return (10 > f ? "0" : "") + f;
  };
  ...
  var d = (function () {
      function f(a, m, v) {
          ...
          return this instanceof f
              ? ((this.items = a),
                (x = this.id = l()),
                (this.settings = g.extend({}, this.settings, m)),
                (k[x] = this),
                a.each(function (w, E) {
                    g(E).data("runner", x);
                }),
                this.value(this.settings.startAt),
                void ((v || this.settings.autostart) && this.start()))
              : new f(a, m, v);
      }
      return (
          (f.prototype.running = !1),
          (f.prototype.updating = !1),
          (f.prototype.finished = !1),
          (f.prototype.interval = null),
          (f.prototype.total = 0),
          (f.prototype.lastTime = 0),
          (f.prototype.startTime = 0),
          (f.prototype.lastLap = 0),
          (f.prototype.lapTime = 0),
          ...
          (f.prototype.update = function () {
              ...
              this.updating ||
                  ...
                  (m = w - this.lastTime),
                  (this.lastTime = w),
                  a ? (this.total -= m) : (this.total += m),
                  null !== x && ((a && this.total <= x) || (!a && this.total >= x)) && ((this.total = x), (this.finished = !0), this.stop(), this.fire("runnerFinish")),
          ...
          (f.prototype.lap = function () {
              var a, m;
              return (m = this.lastTime), (a = m - this.lapTime), this.settings.countdown && (a = -a), (this.running || a) && ((this.lastLap = a), (this.lapTime = m)), (m = this.format(this.lastLap)), this.fire("runnerLap"), m;
          }),
...
function symbolab_log(c, g, k, r) {
  r ||= null;
  if (k && "string" === typeof k && k.startsWith("MobileWeb")) {
      if ("undefined" == typeof OS || "" === OS) OS = "Unknown";
      k = OS + "_" + k;
  }
  "undefined" != typeof sy_var && "Registration" === c && k && (k = "Var" + sy_var + "\t" + k);
  return $.ajax({
      type: "POST",
      url: "/detailedLog",
      data: { type: c, info1: g, info2: k, query: r },
  });
}
...
function prepareQueryForMathQuill(c) {
  ...
  c = c.replace(/\\hat\{(.+?)\}/g, "\\hat{$1 }");
  return (c = c.replace(/ /g, "#"));
}
function getWidth(c, g) {
  var k = 0;
  if (c.hasClass("block") || c.hasClass("numerator") || c.hasClass("denominator"))
...
$(function () {
  ...
  $("select.classification").change(function (q) {
      ...
      1 < z.children().size() && (z.removeClass("hidden"), z.removeAttr("disabled"));
  });
...
function showUpgradeMessage() {
  "undefined" != typeof mobileWeb && mobileWeb
      ? "iOS" === OS
          ? confirm("Download the app to see steps. Redirect to App Store?") && (window.location = "https://itunes.apple.com/app/id876942533")
          : "Android" === OS && confirm("Download the app to see steps. Redirect to Google Play?") && (window.location = "https://play.google.com/store/apps/details?id=com.devsense.symbolab")
...
function showSignUp(c, g) {
  var k = c.split("\t");
  0 <= k.indexOf("LockedStep")
      ? (window.location = getRegistrationUrl("lock", c, g))
      : 0 <= k.indexOf("Graphing") || 0 <= k.indexOf("Solver")
      ? (window.location = getRegistrationUrl("upgrade", c, g))
      : 0 <= k.indexOf("SolverSaveNote")
      ? (window.location = getRegistrationUrl("notebook", c))
      : 0 <= k.indexOf("GraphSave")
      ? (window.location = getRegistrationUrl("signup", c, g))
      : (window.location = getRegistrationUrl("signup", c));
}
...
function getFixedStepsFormatAPI(c) {
  for (var g = [], k = 0; k < c.length; k++) {
      ...
      if ("interim" === r.type) g.push(r);
          ...
          r.entire_result && g.push({ entire_result: r.entire_result });
      } else g.push(r);
  }
  return g;
}
...
function refreshLeftNavbarHeight() {
  ...
  0 < c &&
      ($("#navbarStyle").remove(),
      $("head").append($("<style id='navbarStyle'>.nl-leftNav { min-height: " + (c + 110) + "px; }</style>")),
      $("head").append($("<style id='navbarStyle'>.sidebar-content { min-height: " + (c + 100) + "px; }</style>")));
}
...
function prepareGeometryForReload() {
  return "undefined" != typeof SYGEO
      ? SYGEO.doShareCreateRequest().then(function (c) {
...
$(function () {
  ...
  function k(l) {
      ...
      $.ajax({
          ...
          success: function (d) {
              d.alert
                  ? ($(".nl-signInWithText .nl-error").text(d.alert), $(".nl-signInWithText .nl-error").show(), l.removeClass("nl-disabled"), z.reject())
  ...
  $(".nl-search").click(function (l) {
      ...
      $(l.originalEvent.target).is(q) ||
          (q.val(""),
          (l = $("#nl-mainNav")),
          l.toggleClass("nl-searchOpen"),
          l.hasClass("nl-searchOpen") && (q.focus(), "/" === window.location.pathname ? symbolab_log("General", "Subject Search Open Homepage") : symbolab_log("General", "Subject Search Open")),
          c());
  });
              ...
              success: function (q) {
                  if (null == q || 0 == q.length) $(".nl-autocomplete").hide();
                      ...
                      for (var z = null, d = 0; d < q.length; d++) {
                          var f = q[d];
                          f.type != z && ($(".nl-autocomplete").append("<div class='type'>" + f.type + "</div>"), (z = f.type));
  ...
  $(".nl-joinEmail").click(function () {
      ...
      l.parent().parent().parent().parent().parent().parent().parent().parent().parent().animate({ scrollTop: 300 });
  });
  ...
  $(".nl-resetButton").click(function () {
      ...
      $.ajax({
          ...
          success: function (q) {
              q.success
                  ? ($(".nl-forgotPassword").hide(), $(".nl-forgotPasswordSuccess").show(), $(".nl-forgotPasswordSuccess .nl-bold").text(q.email))
                  : ($(".nl-forgotPassword .nl-error").text(q.alert), $(".nl-forgotPassword .nl-error").show(), l.removeClass("nl-disabled"));
          },
          error: function () {
              l.removeClass("nl-disabled");
          },
...
function createCustomMatrix(c) {
  ...
  $(".customMatrixTd").click(function () {
      ...
      c.hide();
      "undefined" != typeof SYPAD ? (SYPAD.inputBox().mathquill("write", q, l * t), SYPAD.inputBox().focus()) : ($(".mathquill-editable").mathquill("write", q, l * t), $(".mathquill-editable").focus());
      return !1;
  });
...
function browser() {
  var c = navigator.appName,
      ...
      k,
      r = g.match(/(opera|chrome|safari|firefox|msie)\/?\s*(\.?\d+(\.\d+)*)/i);
...
function liveToggleInvert(c) {
  c
      ? (0 == $("#invert-style").size() && $("head").append($(invertStyleContents)), $(".nl-lightsOutSwitch").attr("title", i18n("js.Lights on")))
      : ($("#invert-style").remove(), $(".nl-lightsOutSwitch").attr("title", i18n("js.Lights out")));
}
function liveToggleInvertHomepage(c) {
  c
      ? (0 === $("#invert-style").size() && ($("head").append($(invertStyleContentsHomepage)), $(".toggle_mini_keypad .open").attr("src", "/public/images/toggle_open_dm.png")), $(".nl-lightsOutSwitch").attr("title", i18n("js.Lights on")))
      : ($("#invert-style").remove(), $(".nl-lightsOutSwitch").attr("title", i18n("js.Lights out")), $(".toggle_mini_keypad .open").attr("src", "/public/images/toggle_open.png"));
  graphingSlider(c);
}
function graphingSlider(c) {
  c && 0 < $("#sliders-button").length
      ? 0 === $("#sliders-button.hide").length
          ? ($("#sliders-button-inverse").attr("class", "sliders-button-inverse"), $("#sliders-button-close-inverse").attr("class", "sliders-button-inverse hide-important"))
          : ($("#sliders-button-inverse").attr("class", "sliders-button-inverse hide-important"), $("#sliders-button-close-inverse").attr("class", "sliders-button-inverse"))
      : !c &&
        0 < $("#sliders-button-inverse").length &&
        (0 === $("#sliders-button-inverse.hide-important").length
            ? ($("#sliders-button").attr("class", "sliders-button"), $("#sliders-button-close").attr("class", "sliders-button hide"))
            : ($("#sliders-button").attr("class", "sliders-button hide"), $("#sliders-button-close").attr("class", "sliders-button")));
}
...
function lightsOut() {
  "true" === getInverseCookieValue()
      ? (createInvertCookie("false"), liveToggleInvert(!1), symbolab_log(getProductByUrl(), "LightsOn", null))
      : (createInvertCookie("true"), liveToggleInvert(!0), symbolab_log(getProductByUrl(), "LightsOut", null));
}
...
function lightsOutHomepage() {
  "true" === getInverseCookieValue()
      ? (createInvertCookie("false"), liveToggleInvertHomepage(!1), symbolab_log(getProductByUrl(), "LightsOn", null))
      : (createInvertCookie("true"), liveToggleInvertHomepage(!0), symbolab_log(getProductByUrl(), "LightsOut", null));
}
...
(function (c) {
  ...
  c.whenAll = function (k) {
      ...
      for (var t = 1 == arguments.length && c.isArray(k) ? k : g.call(arguments), l = t.length, q = l, z = c.Deferred(), d = 0, f = 0, a = Array(l), m = Array(l), v = Array(l), x; d < l; d++)
          (x = t[d]) && c.isFunction(x.promise) ? x.promise().done(r(d, v, t)).fail(r(d, a, m)) : (z.notifyWith(this, x), --q);
      q || z.resolveWith(v, t);
      return z.promise();
  };
})(jQuery);
...
function readCookie(c) {
  ...
  for (var g = document.cookie.split(";"), k = 0; k < g.length; k++) {
      for (var r = g[k]; " " === r.charAt(0); ) r = r.substring(1, r.length);
...
function shareClick({ url: c, title: g, logAction: k }) {
  a2a_config.linkurl = c;
  a2a_config.linkname = g;
  a2a_config.logAction = k;
  "undefined" == typeof a2a
      ? ((c = document.createElement("script")), (c.type = "text/javascript"), (c.src = "https://static.addtoany.com/menu/page.js"), document.getElementsByTagName("head")[0].appendChild(c))
      : (shareClickEventReady && (symbolab_log("Registration", "SeenFeature", a2a_config.logAction + "\tShare"), c || (c = window.location.href), amplitude.track("Seen", { type: "Share", url: c })), (shareClickEventReady = !0));
}
              ...
              $.ajax({
                  ...
                  success: function (k) {
                      ...
                      alertify.okBtn("OK").alert(
                          k.success ? i18n("js.Subscription Resumed") : i18n("js.Operation Failed"),
                          function () {
                              void 0 !== g && (location += g);
                              location.reload();
                          },
...
function loadCourseHeroLink(c, g) {
  if (isUserLoggedIn()) {
      ...
      window.history.replaceState({}, document.title, k);
  } else
...
function loadUpgrade(c) {
  ...
  g.page &&
      ("1" === g.link && $("#UpgradeToProButton").text(i18n("Activate CourseHero Bundle")),
      "upgraded" === g.page
          ? (isSolverFeatureRequestedCancelUpgradeMessage() || $("#nl-successfullySignedPopup").show(),
            symbolab_log("Registration", "SubscribeCompleted-" + g.vendor + "_" + g.planInfo, g.reason),
            amp_log("SubscribeCompleted", "vendor=" + g.vendor + "\tplanInfo=" + g.planInfo, !0),
            isSolverFeatureRequestedCancelUpgradeMessage() ||
                ($("#popup-avatar").hide(),
                "1" === g.link
                    ? ($("#moreText").text(i18n("Subscription active")), $("#successfullySignedUp").text(i18n("Thank you for signing in")), $("#UpgradeToProButton").text(i18n("Activate CourseHero Bundle")))
                    : $("#successfullySignedUp").text(i18n("Thank you for subscribing"))))
          : "signedIn" === g.page && "1" === g.link
          ? ("1" === g.upgradeAttempt ? $("#successfullySignedUp").text(i18n("Your subscription bundle awaits")) : $("#successfullySignedUp").text(i18n("Thank you for signing in")),
            $("#nl-successfullySignedPopup").show(),
            $("#success_image").hide())
          : "signedUp" === g.page
          ? ($("#successfullySignedUp").text(i18n("Thank you for signing up")), $("#nl-successfullySignedPopup").show(), $("#popup-avatar").hide())
          : "ongoingSubscription" !== g.page ||
            isSolverFeatureRequestedCancelUpgradeMessage() ||
            ($("#successfullySignedUp").text("Thank you for your ongoing subscription"), $("#nl-successfullySignedPopup").show(), $("#popup-avatar").hide()),
      $("body")
...
function getPlanText(c) {
  var g = "";
  "monthly" === c
      ? (g = i18n("Subscription renews monthly"))
      : "weekly" === c
      ? (g = i18n("Subscription renews weekly"))
      : "annually" === c
      ? (g = i18n("Subscription renews annually"))
      : "semi" === c && (g = i18n("Subscription renews semi-annually"));
  return g;
}
...
$(document).ready(function () {
  ...
  c.searchParams.has("coursehero")
      ? loadCourseHeroLink(c.searchParams.get("linked"), c.searchParams.get("linkavailable"))
      : ((c = window.location.hash), (c.includes("page=upgraded") || c.includes("page=signedIn") || c.includes("page=signedUp") || c.includes("page=coursehero") || c.includes("page=ongoingSubscription")) && loadUpgrade(c));
  ...
  "undefined" !== typeof amplitude &&
      ((c = getLocalStorage().getItem("linkOrigin")),
      getLocalStorage().removeItem("linkOrigin"),
      (c = amplitude.track("Enter", {
...
function handleGoogleToken(c) {
  ...
  $.ajax({
      ...
      } else (t = $("<p />", { text: t.alert, class: "alert alert-error" })), $("#loginOptionsPanel .alert.alert-error").remove(), $("#loginOptionsPanel").append(t);
  });
}
  ...
  function c() {
      var t = {
          ...
          build: function (l) {
              var q = this.dialogs.buttons.ok,
                  z = "<div class='dialog'><div>" + this.dialogs.message.replace("{{message}}", l.message);
          ...
          dialog: function (l, q, z, d) {
              return this.setup({ type: q, message: l, onOkay: z, onCancel: d });
          },
          log: function (l, q, z) {
          ...
          setup: function (l) {
                  ...
                  d &&
                      d.addEventListener("click", function (w) {
                          if (l.onOkay && "function" === typeof l.onOkay)
                              if (a) l.onOkay(a.value, w);
                              else l.onOkay(w);
                          a ? x({ buttonClicked: "ok", inputValue: a.value, event: w }) : x({ buttonClicked: "ok", event: w });
                          g(z);
                      });
                  f &&
                      f.addEventListener("click", function (w) {
                          if (l.onCancel && "function" === typeof l.onCancel) l.onCancel(w);
                          x({ buttonClicked: "cancel", event: w });
                          g(z);
                      });
                  a &&
                      a.addEventListener("keyup", function (w) {
                          13 === w.which && d.click();
                      });
              }
              ...
              var d = z.querySelector(".ok"),
                  ...
                  m = z.querySelector("label");
              a &&
                  ("string" === typeof this.promptPlaceholder && (m ? (m.textContent = this.promptPlaceholder) : (a.placeholder = this.promptPlaceholder)),
                  "string" === typeof this.promptValue && (a.value = this.promptValue),
                  "string" === typeof this._inputType && (a.type = this._inputType));
              var v;
      ...
      return {
          ...
          confirm: function (l, q, z) {
              return t.dialog(l, "confirm", q, z) || this;
          },
...
var init_user_page = function (c, g, k, r, t, l) {
  ...
  c && (this.stripe = Stripe(c, { locale: l }));
  var z;
  $(".settingsSelect")
      .focus(function () {
          z = this.value;
      ...
      .change(function (d) {
          d = $(this).attr("field");
          var f = $(this).val();
          "settings.printOpen" !== d || q
              ? (getLocalStorage().setItem(d, f),
                $.ajax({
                    type: "POST",
                    url: "/api/user/updateUserField",
                    beforeSend: authorizeAjaxWithSyToken,
                    data: { field: d, value: f },
                }))
  ...
  $("body")
      ...
      .on("click", "#UpgradeToProButtonFromUserPage:not(.nl-disabled)", function () {
          const d = $(this);
  ...
  $("#update_billingemail").click(function () {
      ...
      $.ajax({
          ...
          data: { email: d, sourceURL: window.location.href },
          beforeSend: authorizeAjaxWithSyToken,
          success: function (f) {
  ...
  $("#editBillingInfo").click(function () {
      $.ajax({
          ...
          success: function (d) {
              ...
              d = f.create("payment", { terms: { card: "never" } });
              ...
              $("#payment-form").on("submit", async (a) => {
                  a.preventDefault();
                  ({ error: a } = await stripe.confirmSetup({
                      elements: f,
                      confirmParams: {
                          payment_method_data: {
                              billing_details: {
  ...
  $("#paypalSubscribeNew").click(function () {
      q
          ? alertify
                ...
                .confirm(
                    i18n("js.Your subscription is active, extend", $("input#throughInput").val()),
                    function () {
  ...
  $("#disableAccountButton").click(function () {
      q && "true" === r
          ? alertify
                .cancelBtn("Cancel")
                .okBtn("Unsubscribe")
                .confirm(i18n("js.Your subscription is active, unsubscribe before deleting your account"), function () {
          ...
          .confirm(
              ...
              function () {
                  $.ajax({
                      ...
                      data: { isMobile: !1 },
                      success: function (d) {
                          d && d.success && $("#clearWebNotesAlert").css("visibility", "visible");
                      },
                  });
              },
              function () {}
  ...
  $("#resetPasswordButton").click(function () {
      ...
      $.ajax({
          ...
          success: function (d) {
              d && d.alert ? ($("#resetPasswordFail").text(d.alert), $("#resetPasswordFail").show()) : ($("#resetPasswordSuccess").show(), $("#curPass").val(""), $("#newPass").val(""), $("#newPass2").val(""));
          },
      });
  });
  ...
  $(".addEmail").click(function () {
      ...
      alertify
          ...
          .cancelBtn(i18n("Cancel"))
          .inputType("password")
          .prompt(i18n("js.Please enter password"), function (d, f) {
              $.ajax({
                  type: "POST",
                  url: "/api/user/updateEmail",
                  beforeSend: authorizeAjaxWithSyToken,
                  data: { newEmail: $("#email").val(), password: d },
                  success: function (a) {
  ...
  $(".edit-avatar").click(function () {
      ...
      $.featherlight(".change-avatar", {
          ...
          beforeClose: function () {
              !0 === $(".featherlight.edit-avatar-popup").data("wasCanceled") && log_user("AvatarCancelEdit");
          },
      });
      $(".upload-error").hide();
...
function unsubscribe(c, g) {
  ...
  $.ajax({
      ...
      success: function (k) {
          ...
          amplitude.track("Unsubscribe", { reason: g });
...
SyPayments.prototype = {
  ...
  showWalletButton: function (c, g, k, r, t) {
      ...
      try {
          (q = l.stripe.elements()),
              (z = l.stripe.paymentRequest({
                  country: this.sy_cid,
                  currency: "usd",
                  total: { label: "Total", amount: Math.round(100 * g) },
                  requestPayerName: !0,
                  requestPayerEmail: !0,
              }));
      } catch (f) {
      ...
      d.on("click", function () {
          symbolab_log("Registration", "SubscribeClicked-stripe_" + c, r);
      });
              ...
              success: function (a) {
                  (async function (m) {
                      ...
                      if (m.result && "ALERT" === m.result) v.text(m.data), $(".error_image1 svg").show(), $(".spinner").hide();
                          ...
                          v = m.clientSecret;
                          var { paymentIntent: x, error: w } = await l.stripe.confirmCardPayment(v, { payment_method: f.paymentMethod.id }, { handleActions: !1 });
                          w
                              ? f.complete("fail")
                              : (f.complete("success"),
                                "requires_action" === x.status && (await l.stripe.confirmCardPayment(v)),
                                $.when(symbolab_log("Registration", "SubscribeCompleted-" + c, r)).always(function () {
      ...
      (async () => {
          ...
          f && (f.googlePay || f.applePay)
              ? (d.mount("#" + k), this.walletPromiseCompletionSource.resolve(!0), t())
              : ((document.getElementById(k).style.display = "none"), this.walletPromiseCompletionSource.reject("No wallet available"));
      })();
  },
  runWalletCheck: function () {
      ...
      (async () => {
          ...
          g && (g.googlePay || g.applePay) ? this.walletPromiseCompletionSource.resolve(!0) : this.walletPromiseCompletionSource.reject("No wallet available");
      })();
  },
      ...
      $.ajax({
          ...
          success: function (q) {
              ...
              if (q.result && "ALERT" === q.result) z.text(q.data), $(".error_image1 svg").show(), $(".spinner").hide();
                  ...
                  q = d.create("payment", { terms: { card: "never" } });
                  q.on("ready", function () {
                      $(".spinner").hide();
                  ...
                  $("#payment-form").on("submit", async (f) => {
                      ...
                      const { error: a } = await l.stripe.confirmPayment({
                          elements: d,
                          confirmParams: {
                              payment_method_data: {
                                  billing_details: {
  ...
  renderPaypalButton: function (c, g) {
      ...
      $("#express-paypal-button-subsc")
          .off("click")
          .on("click", function () {
              symbolab_log("Registration", "SubscribeClicked-paypal_" + r, t);
              const l = $(this);
              l.addClass("nl-disabled");
              $.ajax({
                  type: "POST",
